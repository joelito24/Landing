		...
		<div class="">
			<div class="top" style="position: relative">
				<div class="container">
					<div class="row">
						<div class="col-sm-4">
							<a href="{{ route('home') }}"><img class="logo" src="{{ asset('front/img/home/logo.png') }}"
									alt=""></a>
						</div>
					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							...
							<div class="contact">
								...
								<a onclick="gtag('event', 'clic', {'event_category': 'enlace-externo', 'event_label': 'numero-telefono' });"
								...
								<img onclick="gtag('event', 'clic', {'event_category': 'enlace-externo', 'event_label': 'direccion-email' });"
									id="emaillink" style="margin-bottom: 10px;cursor: pointer;"
									src="{{ asset('front/img/hola-footer.png') }}" alt="">
								<div class="address">
						...
						<div class="col-sm-6 col-md-4">
							...
							<ul class="menu-footer">
								...
								<li><a href="{{ route('specialization3') }}">eMarketing y publicidad para marcas</a>
								</li>
								<li><a href="{{ route('specialization2') }}">Publicidad online orientada a
										resultados</a></li>
								<li><a href="{{ route('specialization4') }}">Transformación digital para empresas</a>
								</li>
								<li><a href="{{ route('landingagenciaecommerce') }}">Agencia marketing</a></li>
