...
@section('content')
    ...
    <section class="generals">
        <div class="container">
            <div class="row">
                <h2 class="title-page">Política de cookies</h2>
                ...
                <img style="max-width: 766px;width:100%;" src="{{ asset('front/img/cookies-tabla1.png') }}" alt="">
                <p>Según lo dispuesto en el artículo 22.2 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI-CE), THATS ADVERTISING SL informa de las cookies utilizadas en nuestra website:</p>
                <img style="max-width: 520px;width:100%;" src="{{ asset('front/img/cookies-tabla2.jpg') }}" alt="">
                ...
                <a id="config"></a><p>A continuación le proporcionamos los enlaces de diversos navegadores, a través de los cuales podrá realizar dicha configuración:</p>
                <ul>
